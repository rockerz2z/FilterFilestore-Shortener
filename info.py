...
auth_grp = environ.get('AUTH_GROUP', '-1002177626547')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002345121344'))
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'publicearn.in')
